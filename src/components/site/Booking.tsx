  ...
  return (
    <section id="book" className="relative py-24 md:py-36 bg-foreground text-background overflow-hidden">
      ...
      <div className="relative mx-auto max-w-5xl px-5 md:px-10 text-center">
        <p className="text-[10px] uppercase tracking-luxe text-rose-gold mb-6">Reserve Your Moment</p>
        <h2 className="font-display text-5xl md:text-7xl leading-[1.02]">
          Book your<br />
          <em className="italic font-normal text-rose-gold">Ella Nora</em> experience.
        </h2>
        ...
        <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-3">
          <button
            ...
            className="group inline-flex items-center gap-3 bg-background text-foreground px-9 py-4 text-[11px] uppercase tracking-luxe hover:bg-blush transition"
          >
            Open Booking
          ...
          <a
            ...
            className="inline-flex items-center gap-3 border border-background/30 px-9 py-4 text-[11px] uppercase tracking-luxe text-background/90 hover:bg-background/10 transition"
          >
            Book in New Tab
          </a>
          <a
        ...
        <div className="mt-14 grid grid-cols-3 gap-4 md:gap-8 max-w-2xl mx-auto text-background/80">
          {[
            ...
            <div key={x.v} className="border-t border-background/20 pt-5">
              <div className="font-display text-2xl md:text-3xl">{x.k}</div>
        ...
        >
          ...
          >
            <div className="flex items-center justify-between px-6 py-4 border-b border-border bg-background">
              <div>
                <div className="text-[10px] uppercase tracking-luxe text-rose-gold">Ella Nora · Booking</div>
