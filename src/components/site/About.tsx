    ...
    <section id="about" className="py-24 md:py-36 bg-background">
      <div className="mx-auto max-w-7xl px-5 md:px-10 grid md:grid-cols-2 gap-12 md:gap-20 items-center">
        <div className="relative order-2 md:order-1">
          <div className="absolute -inset-4 md:-inset-6 bg-blush/40 -z-10" />
          <img
            src={aboutImg}
        ...
        <div className="order-1 md:order-2">
          <p className="text-[10px] uppercase tracking-luxe text-rose-gold mb-5">The House of Ella Nora</p>
          <h2 className="font-display text-4xl md:text-6xl leading-[1.05] text-foreground">
            Expert care.<br />
            <em className="italic font-normal text-rose-gold">Personalised</em> results.
          </h2>
          <div className="mt-8 space-y-5 text-foreground/75 leading-relaxed">
            ...
            <p className="text-foreground italic font-display text-xl md:text-2xl pt-4 border-l-2 border-rose-gold pl-5">
